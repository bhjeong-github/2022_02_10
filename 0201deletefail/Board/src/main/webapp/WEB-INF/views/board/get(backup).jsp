    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="panel-body">
              <ul class="chat">
                 <li class="left clearfix" data-rno="48">
                    <div>
                       <div class="header">
                          <strong class="primary-font">writer1234</strong>
                          <small class="pull-right text-muted">2022-12-25 00:00</small>
                         </div>
                         <p>Merry christmas!</p>
                      </div>
                  </li>
...
/*replyService.update(
   {rno : 48, bno : bnoValue, reply : "수정댓글확인."}, 
   function(result) {
      alert("수정 완료...");
   }
);*/
